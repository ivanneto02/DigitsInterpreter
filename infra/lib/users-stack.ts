...
export class AlphanumericDetectorUsersStack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props: cdk.StackProps) {
        ...
        /* Prevents logging */
        const noLoggingRole = new iam.Role(this, "AlphanumericDetectorLambdaNoLoggingRole", {
            assumedBy: new iam.ServicePrincipal("lambda.amazonaws.com"),
            // No logging permissions - Intentionally omitting CloudWatch log permissions to reduce cost
        }); /* --- */
        ...
        const addUserDataGatewayEndpoint: apigateway.LambdaRestApi = new apigateway.LambdaRestApi(this, "AlphanumericDetectorAddUserDataEndpoint", {
            ...
            cloudWatchRole: false, // disable log - proves too expensive for use case
